;(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    exports["vue-el-intersection-observer"] = factory(require("vue"))
  else root["vue-el-intersection-observer"] = factory(root["Vue"])
})(
...
***************************************************************************** */
          ...
          function forwardStaticMembers(Extended, Original, Super) {
            ...
            Object.getOwnPropertyNames(Original).forEach(function (key) {
              ...
              if (!hasProto) {
                ...
                var superDescriptor = Object.getOwnPropertyDescriptor(
                  Super,
                  key
                )
                ...
                var emit = function (returnValue) {
                  ...
                  if (returnValue === undefined) {
                    if (args.length === 0) {
                      ...
                      _this.$emit.apply(
                        _this,
                        Emit_spreadArrays([emitName], args)
                      )
                    }
                  } else {
          ...
          function produceProvide(original) {
            var provide = function () {
              ...
              rv[reactiveInjectKey] = Object.create(
...
//# sourceMappingURL=vue-el-intersection-observer.umd.js.map
